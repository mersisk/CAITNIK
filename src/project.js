...
export const project = {
  ...
  form: {
    ...
    note: "Расскажите о празднике, а после подключения отправки менеджер сможет связаться с вами для уточнения деталей.",
    submitLabel: "Отправить заявку",
    successLocal: "Заявка сохранена только на этом устройстве и пока не отправлена менеджеру.",
