...
export const project = {
  ...
  about: {
    ...
    decoratorText: "Здесь напишите имя декоратора и коротко расскажите о себе: почему вы выбрали эту профессию, что любите в своей работе и что для вас важно в каждом празднике.",
    recentTitle: "Последние работы компании",
    recentText: "Здесь можно рассказать о недавних проектах: какие события вы оформляли, какие идеи воплотили и чем особенно гордитесь.",
    recentWorks: [
    ...
    generalText: [
      "Здесь напишите основную историю «Арт-деко»: когда появилась компания, с какими событиями вы работаете и в каких городах принимаете заказы.",
      "Добавьте несколько предложений о подходе к работе, команде, материалах и том, что получает клиент при заказе оформления.",
    ],
    gallery: [
      { src: "./assets/photo_42_2026-09-05_20-25-50.jpg", alt: "Праздничный стол с цветочным оформлением в розовых оттенках", caption: "Оформление праздничных столов" },
      { src: "./assets/photo_56_2026-09-05_20-25-50.jpg", alt: "Свадебная фотозона с цветами и светлой драпировкой", caption: "Фотозоны для особенных событий" },
      { src: "./assets/photo_100_2026-09-05_20-25-50.jpg", alt: "Светлое оформление стола с воздушными цветочными композициями", caption: "Декор в единой концепции" },
    ],
  },
  phone: {
